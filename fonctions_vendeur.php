...
if(isset($_POST['ajouter_vendeur']))
{
    ...
    if($uploadOk)
    {
        ...
        {
            $sql2 = mysqli_query($con, "INSERT INTO vendeur(Nom, Pseudo, Mail, Photo, Fond, Password) VALUES ('$nom', '$pseudo', '$email', '$imageName', '$fond', '$password')");
...
if(isset($_POST['ajouter_item']))
{
    ...
    $query = mysqli_query($con, "SELECT * FROM vendeur WHERE Pseudo = '$pseudo'");
    ...
    if($upload1 && $upload2 && $upload3)
    {
        ...
        {
            $sql2 = mysqli_query($con, "INSERT INTO item(Nom, Image1, Image2, Image3, prix1, typeVente, Categorie, Description, vendeur_mail) VALUES ('$titre', '$image1', '$image2','$image3', '$prix', '$type', '$categorie', '$description', '$email')");
            header("Location: vendre.php");
        }
        else
        {
            $sql2 = mysqli_query($con, "INSERT INTO item(Nom, Image1, Image2, Image3, Prix, typeVente, Categorie, Description, vendeur_mail) VALUES ('$titre', '$image1', '$image2','$image3', '$prix', '$type', '$categorie', '$description', '$email')");
            header("Location: vendre.php");
        }
