    ...
    <center><table>
        ...
        <td>Type de carte :</td>
            ...
            <td colspan="2" align="center">
                <br>
                <button class="btn btn-outline-secondary btn-lg" name="finaliser_achat_offre">Ajouter</button>
        </td></tr>
    </table></center>
</form><br><br>
...
if(isset($_POST['finaliser_achat_offre']))
{
    $type = $_POST['type'];
    $numero = $_POST['numero'];
    $nom = $_POST['nom'];
    ...
    {
        header("Location: meilleures_offres.php");
